...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      "nav.buy": "Buy PALU",
      "hero.tagline":
        "Palu is a playful, community-first meme token on BNB Chain. Zero tax, liquidity locked, and built for fun. Learn, build, and meme with us.",
      "hero.buyOnBnb": "Buy on BNB",
      "hero.copy": "Copy Contract",
      "ticker.part1": "$PALU • 0% TAX • LIQUIDITY LOCKED • COMMUNITY OWNED",
      ...
      // Memes i18n
      "memes.title": "Palu Memes",
      "memes.subtitle": "Check out Palu memes and post mentions!",
      "memes.post0Content":
    ...
    zh: {
      ...
      "hero.copy": "复制合约地址",
      "ticker.part1": "$PALU • 0% 税收 • 流动性锁定 • 社区所有",
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  class PaluTokenStats {
    constructor() {
      this.tokenAddress = "0xb75a7e8876df49a74cc4c76c6bda161a8ea4b483";
